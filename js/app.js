    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems) rangeItems.forEach((rangeItem => {
                ...
                const rangeNum = rangeItem.querySelector("[data-range-num]");
                const rangeInp = rangeItem.querySelector("[data-range-inp]");
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    rangeNum.innerHTML = values[handle] + " USD";
                }));
        ...
        da.init();
        const langBtn = document.querySelector(".lang-box-header__btn");
        langBtn.addEventListener("click", (function(e) {
            let langBox = document.querySelector(".lang-box-header__drop-box");
            langBox.classList.toggle("_open");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
